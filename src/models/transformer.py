...
class FFExtractor(nn.Module):
    def __init__(self,
                 ...
                 deep_learner=False,
                 deep_dense=False,
                 eps: float=0.1, momentum: float=0.5):
        ...
        self.cnn_block_super_deep_transition = nn.Sequential(
                                                ...
                                                nn.Conv2d(in_channels=256,
                                                          ...
                                                          kernel_size=(3, 3),
                                                          stride=1, padding=0),
                                                nn.InstanceNorm2d(num_features=512, momentum=momentum, eps=eps, affine=True),
                                                ...
                                                nn.Conv2d(in_channels=512,
                                                          ...
                                                          kernel_size=(3, 3),
                                                          stride=1, padding=0),
                                                nn.InstanceNorm2d(num_features=256, momentum=momentum, eps=eps, affine=True),
                                                nn.PReLU(num_parameters=1),
        )
        ...
        self.cnn_final = nn.Sequential(
                                 ...
                                 nn.Conv2d(in_channels=256,
                                           ...
                                           kernel_size=(3,3),
                                           stride=1, padding=0),
                                 nn.InstanceNorm2d(num_features=128, momentum=momentum, eps=eps, affine=True),
                                 nn.PReLU(num_parameters=1),
                                 ...
                                 nn.Conv2d(in_channels=128,
                                           ...
                                           kernel_size=(3,3),
                                           stride=1, padding=0),
                                 nn.InstanceNorm2d(num_features=64, momentum=momentum, eps=eps, affine=True),
                                 nn.PReLU(num_parameters=1),
                                 ...
                                 nn.Conv2d(in_channels=64,
                                           ...
                                           kernel_size=(3,3),
                                           stride=1, padding=0),
                                 nn.InstanceNorm2d(num_features=matrix_size, momentum=momentum, eps=eps, affine=True)
        )
...
class MTranspose(nn.Module):
    def __init__(self, matrix_size=32,
                 ...
                 eps: float=1e-5, momentum: float=0.5):
